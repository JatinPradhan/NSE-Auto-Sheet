...
# आपकी शीट की ID 
spreadsheet_id = "1DYC5T8UCkqGxTWJWiRbO9A4pmWXxagOmBcbVsb_1THk "

# दोनों शीट्स को कनेक्ट करना
try:
    ws_volume = client.open_by_key(spreadsheet_id).worksheet("Top 250 Stocks")मुफ्त स्टॉक शिक्षा
...
def fetch_bhavcopy_for_date(date_obj):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"NSE सर्वर ने {response.status_code} रिस्पॉन्स दिया।")वॉल्यूम विश्लेषण
            return None, None
    except Exception as e:
        print(f"Error: {e}")
        return None, None
...
if data_vol_to_insert and data_turnover_to_insert:
    try:
        ...
        print(f"Google Sheet अपडेट करने में एरर: {e}")स्प्रेडशीट सॉफ़्टवेयर
        exit(1)
else:
